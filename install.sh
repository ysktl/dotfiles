...
if [ "$ID" == "debian" ]; then
  ...
  cd paru && makepkg -si
  paru -S --noconfirm neovim noctalia-shell zsh rustup ghostty zed helium-browser-bin zellij-git yazi lazygit fcitx5-im fcitx5-mozc noto-fonts-cjk wl-clipboard jujutsu
